...
#### copied from Stephanie'e Spin 0 model

GC_109 = Coupling(name = 'GC_109',
                  value = 'cmath.sqrt(cmath.pi/aEW)*GCH*complex(0,1)',
                  order = {'QED':2})

GC_110 = Coupling(name = 'GC_110',
                  value = 'complex(0,1)*(cmath.pi/aEW)*GCH**2',
                  order = {'QED':4})

#### obtained from the monopole Lagrangian of spin 1
...
GC_113 = Coupling(name = 'GC_113',
                value = 'complex(0,1)*GCH*cmath.sqrt(cmath.pi/aEW)*kappamon',
                order = {'QED':1})
